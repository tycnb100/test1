...
public class DateUtil {
	...
	public static Date getWeekEndDay() {
		try {
			...
			return format.parse(getWeekEndDayString());
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public static Date getWeekStartDay() {
		try {
			SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
			return format.parse(getWeekStartDayString());
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public static String getWeekStartDayString() {
		...
		if (w == 1) {
			return DateUtil.addDays(DateUtil.getCurrentTime(), -6);
		} else {
	...
	public static void main(String a[]) {
		try {
			...
			System.out.println(getWeekStartDayString());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	 ...
	 * @return
	 */
	public static int getWeekOfDateNum(String dateStr) {
		try {
			SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
			Date date = format.parse(dateStr);
			return getWeekOfDateNum(date);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return -1;
