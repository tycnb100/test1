...
public class Constant {
	...
	// 内嵌分页名称
	public static final String	SESSION_PAGE_UNIT			= "SESSION_PAGE_UNIT";
	public static final String	SESSION_BEAN				= "SESSION_BEAN";
	public static final String	WEB_BEAN					= "WEB_BEAN";
	public static final int		SESSION_PAGE_NUMBER			= 30;
	...
	public static final int		duoxuan						= 4;
	public static final int		panduan						= 4;
	public static final int		tiankong					= 5;
	public static final int		jianda						= 10;
}
