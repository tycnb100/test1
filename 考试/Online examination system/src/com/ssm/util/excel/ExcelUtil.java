...
public class ExcelUtil {
	public static void main(String[] args) {
		try {
			InputStream in = new FileInputStream(new File("学生信息模板.xls"));
			String sheetName = "Sheet1";
			LinkedHashMap<String, String> fieldMap = new LinkedHashMap<String, String>();
			fieldMap.put("班级名称", "classesSid");
			fieldMap.put("学生编号", "sid");
			fieldMap.put("学生姓名", "name");
			fieldMap.put("登录密码", "password");
			fieldMap.put("性别(男/女)", "gender");
			fieldMap.put("电子邮箱", "email");
			fieldMap.put("手机号码", "phone");
			fieldMap.put("民族", "nation");
			fieldMap.put("父亲姓名", "father");
			fieldMap.put("母亲姓名", "mother");
