...
<div class="bjui-pageHeader">
	<form data-toggle="ajaxsearch" action="${ctx}/sys/queryStudentExamAll.do" id="pagefrom_${actionclass}">
	...
	<table class="table table-bordered" data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        ...
        <tbody>
            ...
            <tr data-id="${item.id }">
                ...
                <td>
					<a href="${ctx}/sys/getStudentExam.do?uid=${item.id}" class="btn btn-green" target="_selfexam">阅卷</a>
				</td>
            </tr>
            </c:forEach>
        </tbody>
