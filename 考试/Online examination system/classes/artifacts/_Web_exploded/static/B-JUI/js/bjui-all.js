...
+function ($) {
    ...
    Bjuiajax.prototype.ajaxcallbackchecked = function(json) {
        var that = this, options = that.options,
            okCallback = options.okCallback, errCallback = options.errCallback, okAfterCallback = options.okAfterCallback,
            tabids = [], dialogids = [], divids = [], datagrids = []
    ...
    Bjuiajax.prototype.doajaxchecked = function(options) {
        ...
        var todo = function() {
            ...
            $element.doAjax({type:options.type, url:options.url, data:options.data, 
            		callback:callback ? callback : $.proxy(function(data) {that.ajaxcallbackchecked(data)}, that)})
        }
...
+function ($) {
    ...
    Datagrid.prototype.init = function() {
        ...
        that.paging = $.extend({}, {pageSize:30, selectPageSize:'30', pageCurrent:1, total:0, showPagenum:5}, (typeof options.paging === 'object') && options.paging)
