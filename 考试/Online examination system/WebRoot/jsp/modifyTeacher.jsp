...
<div class="bjui-pageContent">
	<form action="${ctx}/sys/update${actionclass}.do" id="j_custom_form" data-toggle="ajaxform">
		...
		<div class="bjui-row col-3">
			...
			<div class="row-input">
				<input type="hidden" value="${modifybean.photo}" name="photo_"/>
				<input type="file" data-name="photo" name="photo" data-toggle="webuploader"
					data-options="
		               {
		                   pick: {label: '点击选择文件'},
		                   ...
		                   formData: {dir:'upload'},
		                   required: true,
		                   uploaded: '${ctx}/resource/${modifybean.photo}',
		                   basePath: '',
		                   upunit: '个文件',
		                   accept: {
		                       title: '文件',
			...
			<br />
			<label class="row-label">工号</label>
			...
			<div class="row-input">
				<input type="password" name="userPassword" id="${actionclass}_userPassword" value="" data-rule="">
			</div>
			...
			<div class="row-input">
				<input type="text" name="userPhone" id="${actionclass}_userPhone" value="${modifybean.userPhone}" data-rule="mobile" maxlength="11">
			</div>
			...
			<div class="row-input">
				<input type="text" name="userBirth" id="${actionclass}_userBirth" value="${modifybean.userBirth}"
					data-toggle="datepicker" data-pattern="yyyy-MM-dd" readonly="readonly">
			</div>
...
<script type="text/javascript">
	$("#${actionclass}_userGender").val("${modifybean.userGender}");
</script>