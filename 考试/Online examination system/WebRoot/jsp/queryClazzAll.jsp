...
<div class="bjui-pageHeader">
	<form data-toggle="ajaxsearch" action="${ctx}/sys/queryClazzAll.do" id="pagefrom_${actionclass}">
	...
	<table class="table table-bordered" data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        ...
        <tbody>
            ...
            <tr data-id="${item.id }">
                ...
                <td>
                	<a href="${ctx}/sys/add2ClazzStudent.do?uid=${item.id}" class="btn btn-green" data-toggle="navtab"
							data-options="{reloadWarn:''}" data-id="baseAdd" data-reload-warn="本页已有打开的内容，确定将刷新本页内容，是否继续？"
							data-title="班级信息">加入</a>
				</td>
            </tr>
            </c:forEach>
        </tbody>
