...
<div class="bjui-pageHeader">
	<form data-toggle="ajaxsearch" action="${ctx}/sys/queryCourseOfTeacher.do" id="pagefrom_${actionclass}">
		<div style="margin: 0; padding: 1px 5px 5px;">
			<span>科目名称:</span>
			<input type="text" name="s_name" class="form-control" size="13">
	...
	<table class="table table-bordered" data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        ...
        <tbody>
            ...
            <tr data-id="${item.id }">
                ...
                <td>
					<a href="${ctx}/sys/getCourseClazz.do?uid=${item.id}" class="btn btn-blue" data-toggle="navtab"
						data-options="{reloadWarn:''}" data-id="baseAdd" data-reload-warn="本页已有打开的内容，确定将刷新本页内容，是否继续？"
						data-title="上课班级信息">上课班级</a>
